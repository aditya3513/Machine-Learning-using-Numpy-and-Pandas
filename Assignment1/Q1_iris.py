...
featureName = ["sepal-length", "sepal-width", "petal-length", "petal-width", "class"]

#reading CSV into a DataFrame
iris = pd.read_csv("iris.csv", names = featureName)
...
# we sort the attribute list on basis of the probabilities
  sortedList = sorted(dictionalRow)
